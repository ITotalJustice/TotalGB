...
GB_FORCE_INLINE uint8_t sample_ch1(struct GB_Core* gb);
...
GB_FORCE_INLINE uint8_t sample_ch2(struct GB_Core* gb);
...
GB_FORCE_INLINE uint8_t sample_ch3(struct GB_Core* gb);
...
GB_FORCE_INLINE uint8_t sample_ch4(struct GB_Core* gb);
