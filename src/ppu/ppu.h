...
GB_FORCE_INLINE uint8_t hdma_read(const struct GB_Core* gb, const uint16_t addr);
...
GB_FORCE_INLINE void ppu_write_pixel(struct GB_Core* gb, uint32_t c, uint8_t x, uint8_t y);
